load '../DessinsEtSauvegarde/Vitesses/Domaine3D.mat'
lon=lon_;lat=lat_;
Zoom=0;
...
if (strcmp(Categorie,'Entero')==1)
   ...
   % DCO=ConcDomaine*3216/180000;
     DCO=ConcDomaine/399000*12770*10;
    DCO_Min=0;DCO_Max=10;
    DCO_Min=0;DCO_Max=40;NbEtape=4;DcoMin=0;
    Seuil1=100;Seuil2=370;
    PanacheSelec='PanacheSelecEntero';
elseif (strcmp(Categorie,'Coli')==1)
    Dossier='../DessinsEtSauvegarde/EColi/';N_T2=1;
    if FirstColi
       Enertime3D_Relecture
       FirstEntero=true;
       FirstColi=false;
